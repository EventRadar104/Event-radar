-- Adds venue_lat IS NOT NULL AND venue_lng IS NOT NULL filter to search_events()
-- so events without map coordinates are excluded at the database level.
--
-- Run this in the Supabase SQL editor (or via supabase db push).
-- Compare the function body below with the existing definition in your project
-- (Database → Functions → search_events) before applying and adjust if needed.
