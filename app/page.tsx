...
function buildHref(params: SearchParams, overrides: Partial<SearchParams & { weekend?: string }>): string {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <Link
          href={buildHref(params, { free: 'true' })}
          style={{
            padding: '9px 22px', borderRadius: 8, fontSize: 13,
            fontWeight: 500, textDecoration: 'none',
            border: '1px solid var(--border)',
            background: onlyFree ? '#111' : '#fff',
            color: onlyFree ? '#fff' : 'var(--ink2)',
          }}
        >
          Free events
        </Link>
